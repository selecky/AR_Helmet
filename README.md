...
3. Build and deploy the app to a supported Android or iOS device.

## Usage
1. Launch the app on your mobile device.
2. Point your device's camera at the helmet marker image.
3. Interact with the spawned helmet model using the on-screen buttons:
    - **Rotate Left**: Rotates the helmet counterclockwise.
    - **Rotate Right**: Rotates the helmet clockwise.
